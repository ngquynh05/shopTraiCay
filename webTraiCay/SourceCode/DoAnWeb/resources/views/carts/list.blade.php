                            ...
                            <div class="wrap-table-shopping-cart">
                                ...
                                <table class="table-shopping-cart">
                                    ...
                                    <tr class="table_head">
                                        ...
                                        <th class="column-3">tiền/kí</th>
                                        <th class="column-4">số kí</th>
                                            ...
                                            <td class="column-4">
                                                <div class="wrap-num-product flex-w m-l-auto m-r-0">
                                                    ...
                                                    {{-- <input class="mtext-104 cl3 txt-center num-product" type="number"
                                                           ...
                                                           <input class="mtext-104 cl3 txt-center num-product" type="number" name="num_product[{{ $product->id }}]" value="{{ $carts[$product->id] }}" min="1">
